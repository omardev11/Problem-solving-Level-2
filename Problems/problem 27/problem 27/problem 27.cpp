...
int mininumber(int array[100], int arraylength)
{
    int mini = 100;
    for (int i = 0; i < arraylength; i++)
    {
...
float avarageofarraynumbers(int array[100], int arraylength)
{
...
int main()
{
    ...
    cout << endl << "sum of array numbers is " << sumofarraynumbers(array, arraylength);
    cout << endl << "avarage of array numbers is " << avarageofarraynumbers(array, arraylength);
