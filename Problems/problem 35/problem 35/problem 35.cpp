...
{
    if (findnumberpossotioninarray(array, arraylength, numbertocheck) == -1)
    {
        return 0;
    }
    else
...
int main()
{
    ...
    short numberpossotion = isnumberinarray(array, arraylength, numbertosearch); cout << endl;
    if (numberpossotion == 0)
    {
