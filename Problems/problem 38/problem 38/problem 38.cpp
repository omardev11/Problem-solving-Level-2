...
void coppyarrayprimenumbersusingaddarrayelement(int array[100], int array2[100], int arraylength, int& arraylength2)
{
    for (int i = 0; i < arraylength; i++)
    {
...
int main()
{
    ...
    coppyarrayprimenumbersusingaddarrayelement(array, array2, arraylength, arraylength2); cout << endl;
